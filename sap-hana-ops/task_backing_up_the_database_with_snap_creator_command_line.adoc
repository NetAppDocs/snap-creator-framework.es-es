...
summary: También puede realizar una copia de seguridad de la base de datos mediante la línea de comandos de Snap Creator. 
---
= Realizar backups de la base de datos con la línea de comandos de Snap Creator
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
También puede realizar una copia de seguridad de la base de datos mediante la línea de comandos de Snap Creator.

. Para realizar una copia de seguridad de la base de datos, ejecute el siguiente comando.
+
[listing]
----
