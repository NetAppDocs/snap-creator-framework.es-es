...
. [[thirteenth-step]]En la página de detalles de la instantánea, especifica la información de configuración de la instantánea:
+
|===
| Para este campo... | Realice lo siguiente... 
...
.. Las instrucciones se encuentran en el siguiente paso<<thirteenth-step,13>>.
