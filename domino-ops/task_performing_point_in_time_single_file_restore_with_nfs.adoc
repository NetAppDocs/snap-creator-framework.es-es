...
NOTE: Si estás restaurando desde una copia de SnapVault, se te pedirá que restaures desde almacenamiento primario o secundario. Tu selección depende de cómo estés manejando la limitación descrita en link:concept_domino_database_restore_overview.html["Concept_domino_database_restore_overview.md#GUID-4D864E27-DE54-43BF-9B9F-EF2F240F65D9"].
