...
Las restauraciones por volumen y las restauraciones de un solo archivo suelen tener directorios de destino diferentes. Especificas el directorio de destino en el parámetro Directorio de restauración de datos del archivo de configuración de backup y restauración (consulta el paso link:task_using_the_gui_to_create_a_configuration_file.html["tarea que utiliza la gui para crear un archivo de configuración"]):
