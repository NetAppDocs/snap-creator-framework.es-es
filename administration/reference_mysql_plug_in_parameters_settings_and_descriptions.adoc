...
(S|N )
 a| 
El parámetro funciona para la configuración de la base de datos maestro-esclavo MySQL.

Si se establece como Y, purgará los registros binarios al último archivo de registro binario disponible.

Si se establece como N, utiliza la marca de tiempo reciente para la consulta de purga.
