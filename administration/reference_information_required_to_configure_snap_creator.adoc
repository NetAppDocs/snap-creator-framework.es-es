...
data
 a| 
Valida que todos los volúmenes en los que reside la base de datos sean parte de la operación de respaldo. Actualmente existen limitaciones:

* Sólo se admite el sistema de archivos de red (NFS).
* Sólo se comprueban los archivos de datos de las bases de datos compatibles.
