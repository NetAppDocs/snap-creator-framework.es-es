...
(S|N )
 a| 
Si se configura en Y mientras se realiza la copia de seguridad sin conexión de Oracle, utiliza el mecanismo de interrupción de apagado para garantizar que la base de datos se apague en un estado consistente. Los pasos de apagado para el parámetro ORACLE_SHUTDOWNABORT son los siguientes:
