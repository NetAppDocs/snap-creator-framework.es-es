...
NTAP_OSSV_FS_SNAPSHOT_CREATE_CMD
 a| 
 a| 
Ejecute estos scripts o comandos durante o antes del proceso de copia de seguridad de OSSV, donde ## es un número del 01 al 99. Esto se puede utilizar para realizar copias de seguridad del sistema de archivos mediante OSSV.
